...
const Countries = ({
  ...
  let startPage = Math.max(1, currentPage - Math.floor((maxDisplayPagesWithTwoEllipses - 1) / 2));
  let endPage = Math.min(startPage + maxDisplayPagesWithTwoEllipses - 1, totalPages);
